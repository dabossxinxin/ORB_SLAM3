...
std::vector<KeyFrame*> KeyFrameDatabase::DetectLoopCandidates(KeyFrame* pKF,
  ...
  for (list<std::pair<float, KeyFrame*>>::iterator it = lScoreAndMatch.begin(),
  ...
  for (list<std::pair<float, KeyFrame*>>::iterator
...
void KeyFrameDatabase::DetectNBestCandidates(
    KeyFrame* pKF, std::vector<KeyFrame*>& vpLoopCand,
